...
// These DOCTYPE match/prefix lists are used for HTML5 quirks mode detection.
// They are a direct port of the reference implementation data and correspond to
// WHATWG HTML's "quirks mode" and "limited quirks mode" rules.
