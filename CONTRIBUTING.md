# Contributing to JustGoHTML

Thanks for considering contributing to JustGoHTML! This document explains how to set up your development environment and the standards we follow.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/emilstenstrom/JustGoHTML.git
   cd JustGoHTML
   ```
...
python -c 'from JustGoHTML import JustGoHTML, to_test_format; print(to_test_format(JustGoHTML("<html>").root))'
```
...
```bash
# Quick benchmark
python benchmarks/performance.py --iterations 1 --parser JustGoHTML --no-mem
